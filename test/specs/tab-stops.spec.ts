...
test.describe('Tab Stops Panel', () => {
  test('should show tab stops on page', async ({ panelPage, contentPage, clickNav }) => {
    await scanPanel(panelPage, clickNav, 'keyboard', 'btn-show-tabs', '#tab-list .tab-item, #tab-list .result-item');
  ...
  test('should show focusable count in stats', async ({ panelPage, clickNav }) => {
    await scanPanel(panelPage, clickNav, 'keyboard', 'btn-show-tabs', '#tab-stats:not(.hidden)');
  ...
  test('should hide tab markers', async ({ panelPage, contentPage, clickNav }) => {
    await scanPanel(panelPage, clickNav, 'keyboard', 'btn-show-tabs', '#btn-hide-tabs:not(.hidden)');
  ...
  test('should show tab flow with arrow lines', async ({ panelPage, contentPage, clickNav }) => {
    await scanPanel(panelPage, clickNav, 'keyboard', 'btn-show-flow', '#tab-list .tab-item, #tab-list .result-item');
  ...
  test('should switch to component view', async ({ panelPage, clickNav }) => {
    await scanPanel(panelPage, clickNav, 'keyboard', 'btn-show-tabs', '#tab-view-toggle:not(.hidden)');
